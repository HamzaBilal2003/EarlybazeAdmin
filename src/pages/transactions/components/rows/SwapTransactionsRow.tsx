...
interface SwapTransactionsRowProps {
  displayData?: {
    typeimg?: string;
    username: string;
...
const SwapTransactionsRow: React.FC<SwapTransactionsRowProps> = ({ displayData = {}, index = 1 }) => {
        ...
        >
          {justSubmited ? (
            <div className="flex items-center justify-between gap-8">
              ...
              <button onClick={() => setReasonModel(true)} className="bg-red-600 text-white px-12 py-2 rounded-lg">
                Delete
              </button>
            </div>
          ) : (
